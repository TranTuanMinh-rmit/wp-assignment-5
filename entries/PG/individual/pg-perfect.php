...
<body>
    ...
    <div class="shop">
        <div class="title">
            <h1>Perfect Strike Gundam</h1>
        </div>

        <div class="entry-body">
            <div class="pictures-display">
                <div class="pictures-display-pri">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/PG/pg-perfect-strike-gundam-pa_900x900.jpg" alt="" width="85%">
                    <!-- The Modal -->
                ...
                <div class="pictures-display-sec">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/PG/Review Art/PG-Perfect.jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/PG/Review Art/PG-Perfect (2).jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/PG/Review Art/PG-Perfect (3).jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/PG/Review Art/PG-Perfect (4).jpg" alt="" width="16%" height="15%">
                </div>
            </div>

            <div class="display-info">
                <div class="info-header">
                    <p class="scale-era">1/60th scale Pperfect Grade Cosmic Era</p>
                    <p class="gunpla-name">Perfect Strike Gundam</p>
                </div>

                <div class="info-content">
                    <div class="info-price">
                        <a class="info-cost"><span>Price: đ </span>5.600.000</a>
                    </div>
