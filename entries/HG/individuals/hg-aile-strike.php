...
<body>
    ...
    <div class="shop">
        <div class="title">
            <h1>Aile Strike Gundam</h1>
        </div>

        <div class="entry-body">
            <div class="pictures-display">
                <div class="pictures-display-pri">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/HG/HGCE-Aile-Strike-Gundam-boxart.jpg" alt="" width="85%">
                    <!-- The Modal -->
                ...
                <div class="pictures-display-sec">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/HG/Review art/HGCE-Aile-Strike-Gundam (1).png" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/HG/Review art/hgce-Aile-Strike-Gundam (2).jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/HG/Review art/hgce-Aile-Strike-Gundam (3).jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/HG/Review art/hgce-Aile-Strike-Gundam (4).jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/HG/Review art/hgce-Aile-Strike-Gundam (5).jpg" alt="" width="16%" height="15%">
                </div>
            </div>
            ...
            <div class="display-info">
                <div class="info-header">
                    ...
                    <p class="gunpla-name">Aile Strike Gundam (Revive ver.)</p>
                </div>

                <div class="info-content">
                    <div class="info-price">
                        <a class="info-cost"><span>Price: đ </span>500.000</a>
                    </div>
