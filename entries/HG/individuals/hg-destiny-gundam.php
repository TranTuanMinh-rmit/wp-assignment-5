...
<body>
    ...
    <div class="shop">
        <div class="title">
            <h1>Destiny Gundam</h1>
        </div>

        <div class="entry-body">
            <div class="pictures-display">
                <div class="pictures-display-pri">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/HG/hgce-destiny-gundam-boxart.JPG" alt="" width="85%">
                    <!-- The Modal -->
                ...
                <div class="pictures-display-sec">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/HG/Review art/hgce-destiny-gundam-revive (1).jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/HG/Review art/hgce-destiny-gundam-revive (2).jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/HG/Review art/hgce-destiny-gundam-revive (3).jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/HG/Review art/hgce-destiny-gundam-revive (4).jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/HG/Review art/hgce-destiny-gundam-revive (5).jpg" alt="" width="16%" height="15%">
                </div>
            </div>
            ...
            <div class="display-info">
                <div class="info-header">
                    ...
                    <p class="gunpla-name">Destiny Gundam (Revive ver.)</p>
                </div>

                <div class="info-content">
                    <div class="info-price">
                        <a class="info-cost"><span>Price: đ </span>630.000</a>
                    </div>
