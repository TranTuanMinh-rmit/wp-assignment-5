...
<head>
    ...
    <title>MG Zaku Gunner Warrior</title>
...
<body>
    ...
    <div class="shop">
        <div class="title">
            <h1>Zaku Gunner Warrior Lunamaria</h1>
        </div>

        <div class="entry-body">
            <div class="pictures-display">
                <div class="pictures-display-pri">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/mg-gunner-zaku-warrior-lunamaria-hawke-boxart.jpg" alt="" width="85%">
                    <!-- The Modal -->
                ...
                <div class="pictures-display-sec">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/Review Art/mg-gunner-zaku-warrior-lunamaria-hawke-c_1_900x900.jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/Review Art/mg-gunner-zaku-warrior-lunamaria-hawke-c_2_900x900.jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/Review Art/mg-gunner-zaku-warrior-lunamaria-hawke-c_6_900x900.jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/Review Art/mg-gunner-zaku-warrior-lunamaria-hawke-c_4_900x900.jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/Review Art/mg-gunner-zaku-warrior-lunamaria-hawke-c_5_900x900.jpg" alt="" width="16%" height="15%">
                </div>
            </div>

            <div class="display-info">
                <div class="info-header">
                    <p class="scale-era">1/100th scale Master Grade Cosmic Era</p>
                    <p class="gunpla-name">Zaku Gunner Warrior (Lunamaria Hawke Color)</p>
                </div>

                <div class="info-content">
                    <div class="info-price">
                        <a class="info-cost"><span>Price: đ </span>1.000.000</a>
                    </div>
