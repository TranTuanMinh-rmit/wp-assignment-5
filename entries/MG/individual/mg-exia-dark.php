...
<head>
    ...
    <title>MG Exia Dark Matter</title>
...
<body>
    ...
    <div class="shop">
        <div class="title">
            <h1>Exia Dark Matter</h1>
        </div>

        <div class="entry-body">
            <div class="pictures-display">
                <div class="pictures-display-pri">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/mg-gundam-exia-dark-matter-boxart.jpg" alt="" width="85%">
                    <!-- The Modal -->
                ...
                <div class="pictures-display-sec">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/Review Art/mg_exia_dark_matter_1_900x900.jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/Review Art/mg_exia_dark_matter_2_900x900.jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/Review Art/mg_exia_dark_matter_3_900x900.jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/Review Art/mg_gundam_exia_dark_matter_2_1_900x900.jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/Review Art/mg_gundam_exia_dark_matter_2_900x900.jpg" alt="" width="16%" height="15%">
                </div>
            </div>

            <div class="display-info">
                <div class="info-header">
                    <p class="scale-era">1/100th scale Master Grade Build Fighters</p>
                    <p class="gunpla-name">Gundam Exia Dark Matter</p>
                </div>

                <div class="info-content">
                    <div class="info-price">
                        <a class="info-cost"><span>Price: đ </span>1.100.000</a>
                    </div>
