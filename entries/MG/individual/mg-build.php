...
<body>
    ...
    <div class="shop">
        <div class="title">
            <h1>Build Strike Gundam Full Package</h1>
        </div>

        <div class="entry-body">
            <div class="pictures-display">
                <div class="pictures-display-pri">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/MG-Build-Strike-boxart.jpg" alt="" width="85%">
                    <!-- The Modal -->
                ...
                <div class="pictures-display-sec">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/Review Art/MG-Build.jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/Review Art/MG-Build (2).jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/Review Art/MG-Build (3).jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/MG/Review Art/MG-Build (4).jpg" alt="" width="16%" height="15%">
                </div>
            </div>
            ...
            <div class="display-info">
                <div class="info-header">
                    ...
                    <p class="gunpla-name">Build Strike Gundam Full Package</p>
                </div>
