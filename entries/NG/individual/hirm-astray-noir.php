        ...
        <div class="entry-body">
            <div class="pictures-display">
                <div class="pictures-display-pri">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/NG/hi-res-model-gundam-astray-noir-pa_900x900.jpg" alt="" width="85%">
                    <!-- The Modal -->
                ...
                <div class="pictures-display-sec">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/NG/Review Art/hi-res-model-gundam-astray-noir-01_900x900.jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/NG/Review Art/hi-res-model-gundam-astray-noir-02_900x900.jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/NG/Review Art/hi-res-model-gundam-astray-noir-03_900x900.jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/NG/Review Art/hi-res-model-gundam-astray-noir-04_900x900.jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/NG/Review Art/hi-res-model-gundam-astray-noir-05_900x900.jpg" alt="" width="16%" height="15%">
                </div>
            </div>

            <div class="display-info">
                <div class="info-header">
                    <p class="scale-era">High Resolution</p>
                    <p class="gunpla-name">Astray Noir</p>
                </div>

                <div class="info-content">
                    <div class="info-price">
                        <a class="info-cost"><span>Price: đ </span>3.800.000</a>
                    </div>
