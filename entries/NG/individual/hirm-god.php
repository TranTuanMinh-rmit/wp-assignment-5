        ...
        <div class="entry-body">
            <div class="pictures-display">
                <div class="pictures-display-pri">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/NG/hirm-god-gundam_1_900x900.jpg" alt="" width="85%">
                    <!-- The Modal -->
                ...
                <div class="pictures-display-sec">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/NG/Review Art/Hirm-God.jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/NG/Review Art/Hirm-God (2).jpg" alt="" width="16%" height="15%">
                    <img class="myImg" src="../../../resources/images/gundam/boxart/NG/Review Art/hirm-god-gundam_3_900x900.jpg" alt="" width="16%" height="15%">
                </div>
            </div>
            ...
            <div class="display-info">
                <div class="info-header">
                    ...
                    <p class="gunpla-name">God Gundam</p>
                </div>

                <div class="info-content">
                    <div class="info-price">
                        <a class="info-cost"><span>Price: đ </span>2.600.000</a>
                    </div>
